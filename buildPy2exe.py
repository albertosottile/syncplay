...
info = dict(
    ...
    options={'py2exe': {
                         'dist_dir': OUT_DIR,
                         'packages': 'PyQt5.QtUiTools',
                         'includes': 'twisted, sys, encodings, datetime, os, time, math, PyQt5, liburl, ast, unicodedata',
...
sys.argv.extend(['py2exe', '-p win32com ', '-i twisted.web.resource', '-i PyQt5.QtCore', '-p PyQt5.QtGui', '-i PyQt5.QtWidgets'])
setup(**info)
